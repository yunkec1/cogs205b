...
class TestBayesFactor(unittest.TestCase):
    ...
    # intentionally failing test, added for the agent-loop homework
    def test_constructor_rejects_boolean_n(self):
        with self.assertRaises(TypeError) as cm:
            BayesFactor(True, 5)
        self.assertEqual(str(cm.exception), "n must be an integer")
    ...
    def test_evidence_spike_for_n10_k5_is_close_to_likelihood(self):
